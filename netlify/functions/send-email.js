exports.handler = async (event) => {
  ...
  try {
    ...
    html += '<img src="https://ecometric-carbon-calc.netlify.app/logo-512.png" alt="EcoMetric" style="width:180px;height:180px;margin-bottom:15px;">';
    ...
    html += '<img src="https://ecometric-carbon-calc.netlify.app/logo-512.png" alt="EcoMetric" style="width:100px;height:100px;margin-bottom:10px;">';
